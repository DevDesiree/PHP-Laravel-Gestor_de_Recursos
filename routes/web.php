...
Route::group(['prefix' => 'resources'], function () {
    ...
    Route::get('/resources', [CreateResourceController::class, 'index'])->name('resources.index');    Route::get('/create', [CreateResourceController::class, 'create'])->name('resources.create');
