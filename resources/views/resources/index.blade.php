            ...
            <div
                ...
                <div class="flex flex-col items-center pb-10">
                    <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="{{ url('/img/Atefa_1.png') }}"
                        alt="author image" />
                    <h6 class="mb-1 text-xxl px-4 text-center font-small text-gray-900 dark:text-white">{{ $resource->author }}</h6>
                    <h5 class="mb-1 text-xl px-4 text-center font-medium text-gray-900 dark:text-white">{{ $resource->title }}</h5>
                    <h5 class="mb-1 text-lg px-4 text-center font-small text-gray-900 dark:text-white">{{$resource->resourcetype->titleResource }}
                    <h5 class="mb-1 text-lg px-4 text-center font-small text-gray-900 dark:text-white">{{$resource->theme->title }}
                    <h5 class="mb-1 text-xxl px-4 text-center font-small text-gray-900 dark:text-white">{{ $resource->extraResource->url }}
                    </h5>
                    <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ $resource->titleResource }}</h5>
                    ...
                    <div class="flex mt-6 md:mt-6">
                        ...
                        {{-- <a href="{{ route('resources.destroy', $resource->id) }}"
                            class=" w-1/3 px-2 py-2 ms-2 text-sm font-medium text-white text-center focus:outline-none bg-red-500 rounded-lg border border-gray-200 hover:bg-red-700 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Eliminar</a> --}}
                    </div>
                </div>
            </div>
        @endforeach
